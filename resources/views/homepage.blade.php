<x-layout>
        ...
        <div class="w-full text-center text-white text-balance splide__track">
            <ul class="splide__list">
                <li class="px-2 splide__slide">
                    ...
                    <p>Cada paso en el proceso de importación es claro y comunicativo.</p>
                </li>
                <li class="px-2 splide__slide">
                    <h2 class="text-2xl font-bold">Eficiencia</h2>
                    <p>Nos esforzamos por reducir tiempos y costos sin comprometer la calidad.</p>
                </li>
                <li class="px-2 splide__slide">
                    <h2 class="text-2xl font-bold">Orientación al Cliente</h2>
    ...
    <section class="container mx-auto animate__animated animate__fadeInLeft">
        <div class="grid grid-cols-1 text-white md:grid-cols-3">
    ...
    <section id="contact"
        ...
        <form action="" method="post"
            ...
            <input class="px-2 py-3 border border-gray-800 rounded-sm outline-none" type="email" name="ctct-email"
